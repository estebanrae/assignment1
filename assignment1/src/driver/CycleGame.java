...
public class CycleGame extends Game {
	 ...
	 * Cycle Game. Also calls the Game class constructor to initialize all other variables.
	 * 
	 *   @param gameStr
	 ...
	 *   		CanCycle interface
	 */
	public CycleGame(String gameStr, Official[] officials, Athlete[] athletes) {
		...
		do{
			...
			exists = 0;
			if(athletes[offIndex] instanceof CanCycle){
